...
class _HomeState extends State<MainLogin> {
  ...
  Widget build(BuildContext context) {
                  ...
                  SingleChildScrollView(
                    child: Column(children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: _input(Icon(Icons.email),
                         "EMAIL", _emailController, false),
                      ),
                      Padding(
                        padding: EdgeInsets.only(bottom: 20),
                        child: _input(Icon(Icons.lock),
    ...
    /************************************************************* */
    //organaizer registration form
    void _registerOrgnaizerSheet() {
      _scaffoldKey.currentState.showBottomSheet<void>((BuildContext context) {
        return DecoratedBox(
          decoration: BoxDecoration(color: Theme.of(context).canvasColor),
          child: ClipRRect(
                  ...
                  SingleChildScrollView(
                    child: Column(children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: _input(Icon(Icons.arrow_forward_ios),
                            "ORGANAAIZER NAME", _firstNameController, false),
                      ),
                      Padding(
                        padding: EdgeInsets.only(
                          bottom: 20,
                      ...
                      Padding(
                        ...
                        child: Container(
                          child: _button("REGISTER", Colors.white, primary,
                              primary, Colors.white, _registerOrgnaizer),
                          height: 50,
                          width: MediaQuery.of(context).size.width,
                        ),
                      ),
                    ...
                    child: Column(children: <Widget>[
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            ...
                            bottom: MediaQuery.of(context).viewInsets.bottom),
                        child: Container(
                          child: _button("REGISTER AS A USER", Colors.white, primary,
                              primary, Colors.white, _registerUserSheet),
                          height: 50,
                          width: MediaQuery.of(context).size.width,
                        ),
                      ),
                        ...
                        padding: EdgeInsets.only(
                          top:  30,
                            ...
                            bottom: MediaQuery.of(context).viewInsets.bottom),
                        child: Container(
                          child: _button(" REGISTER AS AN\n   ORGANAIZER", Colors.white, primary,
                              primary, Colors.white, _registerOrgnaizerSheet),
                          height: 60,
                          width: MediaQuery.of(context).size.width,
                        ),
                      ),
